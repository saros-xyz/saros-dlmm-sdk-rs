...
/// Credits to: https://github.com/MeteoraAg/dlmm-sdk/blob/main/programs/lb_clmm/src/math/u64x64_math.rs
...
pub fn get_base(bin_step: u8) -> Option<u128> {
    let quotient = (bin_step as u128).checked_shl(SCALE_OFFSET as u32)?;
