...
const SAROS_DLMM_USDC_USDT_POOL: Pubkey = pubkey!("9P3N4QxjMumpTNNdvaNNskXu2t7VHMMXtePQB72kkSAk");
const SAROS_DLMM_SAROS_C98_POOL: Pubkey = pubkey!("BcaE7ehw9sBhXJaBt72eS3RG1ALnuqJLDJ8q8EDM4hG8");
...
test_exact_in_amms! {
    ...
    (SAROS_DLMM_USDC_USDT_POOL, SarosDlmm, 0),
    (SAROS_DLMM_SAROS_C98_POOL, SarosDlmm, 0),
}
